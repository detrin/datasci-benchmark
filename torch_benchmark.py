...
def benchmark_pytorch(n_samples=100000, n_features=20, n_classes=2):  
    ...
    model = SimpleNet(n_features=n_features)  
...
if __name__ == "__main__":  
    ...
    train_time, pred_time = benchmark_pytorch(n_samples=args.rows, n_features=args.cols)  
